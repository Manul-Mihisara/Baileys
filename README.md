...
```json
"dependencies": {
    "baileys": "npm:manul-official-baileys-mod"
}
```
or install in terminal:
```
npm install baileys@npm:manul-official-baileys-mod
```
...
if(usePairingCode && !sock.authState.creds.registered) {
    ...
    const custom = "MANULOFC" // must be 8 digits, can be letters or numbers
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://github.com/Manul-Mihisara/Baileys/issues) here.
